...
insert into user02 values(USER02_seq.nextval, 'user03', '1234', '蜡历3');

commit;

insert into guest02 values (GUEST02_seq.nextval, 'test01', 1, sysdate, 1111);
insert into guest02 values (GUEST02_seq.nextval, 'test02', 3, sysdate, 2222);
insert into guest02 values (GUEST02_seq.nextval, 'test03', 2, sysdate, 3333);
insert into guest02 values (GUEST02_seq.nextval, 'test04', 3, sysdate, 4444);
